...
\usepackage[red]{TKKCBeamer}%嘉庚红

\author[EOE190xx 王瑞芳]{王瑞芳}
\title{厦门大学嘉庚学院非官方\textrm{Beamer}模板}
\subtitle{\textrm{TKKC unofficial Beamer template}}
\institute{厦门大学嘉庚学院xx学院}
\date{\today}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/tkkc-logo.pdf}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item 请使用bibtex编译引用
        \item GitHub项目地址为 \href{https://github.com/Hakureirm/tkkc-beamer}{https://github.com/Hakureirm/tkkc-beamer}，如果有bug或者feature request可以去里面提issue
...
\begin{frame}{主题色选择}
	\begin{itemize}
		...
		\item 厦大蓝使用\textbackslash usepackage[blue]\{TKKCBeamer\}
		\item 嘉庚红使用\textbackslash usepackage[red]\{TKKCBeamer\}
		\item 厦大蓝主题色，无楼群背景使用\textbackslash usepackage\{TKKCBeamer\}
	\end{itemize}
